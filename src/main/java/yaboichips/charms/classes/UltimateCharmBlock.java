...
public class UltimateCharmBlock extends Block {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntityTypes.ULTAMITE_CHARM_CONTAINER.get().create();
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player,
        ...
        if (!worldIn.isRemote) {
            ...
            if (tile instanceof UltimateCharmTE) {
                NetworkHooks.openGui((ServerPlayerEntity) player, (UltimateCharmTE) tile, pos);
