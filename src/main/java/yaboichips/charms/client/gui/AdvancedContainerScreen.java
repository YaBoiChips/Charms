...
public class AdvancedContainerScreen extends ContainerScreen<AdvancedCharmContainer> {
    ...
    public AdvancedContainerScreen(AdvancedCharmContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
