...
public class CharmContainerScreen extends ContainerScreen<CharmContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(Charms.CHARMS, "textures/gui/container.png");


    public CharmContainerScreen(CharmContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
